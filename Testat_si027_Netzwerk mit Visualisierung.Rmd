...
```{r Einfache Visualisierung des Netzwerkes, fig.height=14, fig.width=16}

plot(Kader,                                      #Es können mehrere Layouts für die                                                                Visualisierung verwendet werden bsp.                                                             layout_with_kk ich habe mich jetzt aber für                                                       layout_nicely entschieden, damit wird                                                             automatisch ein passendes Layout gewählt.
                                           
                                                  # Die Knotengröße wird mit Faktor 4                                                               multipliziert um die Knoten etwas u entzerren.
